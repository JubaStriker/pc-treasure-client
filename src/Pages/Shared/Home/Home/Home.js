    ...
    return (
        <div className='p-2 lg:p-10'>
            ...
            <div class="w-full p-4 text-center border-0 rounded-lg sm:p-8 mt-32 ">
                <h5 class="mb-2 text-3xl font-bold text-accent ">Find us on</h5>
                <p class="mb-5 text-base text-secondary sm:text-lg ">Stay updated on the move. Get our mobile app</p>
